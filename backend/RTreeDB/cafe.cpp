                ...
                double lon_max, int min_score)
{
  ...
  auto callback = [min_score](Cafe *cafe)
  {
...
int main(int argc, char* argv[])
{
  ...
  std::vector<Cafe *> cafes = read_cafes_from_csv("../cafes_100.csv");
  ...
  query_area(rtree, 25.02, 121.5, 25.10, 121.6, threshold);
